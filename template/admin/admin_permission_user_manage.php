                ...
                <table>
                    ...
                    <?php foreach($tmpl['alluser'] as $user){?>
                        <?php if($i%6 == 1):?><tr><?php endif;?>
                            <?php if(isset($tmpl['permission_users'][$user['uid']])):?>
                            <td width="150"><input type="checkbox" name="gu[]" value="<?=$user['uid']?>" checked><?=$user['nickname']?></input></td>
                            <?php else:?>
                            <td width="150"><input type="checkbox" name="gu[]" value="<?=$user['uid']?>"><?=$user['nickname']?></input></td>
                            <?php endif;?>
